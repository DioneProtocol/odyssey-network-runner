...
// Shows example usage of the Odyssey Network Runner.
// Creates a local five node Odyssey network
...
func main() {
	...
	binaryPath := fmt.Sprintf("%s%s", goPath, "/src/github.com/DioneProtocol/odysseygo/build/odysseygo")
