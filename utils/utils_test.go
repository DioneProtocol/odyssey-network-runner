...
var genesis = []byte(
	`{
		...
		"allocations": [
		  {
			...
			"dioneAddr": "A-custom1g65uqn6t77p656w64023nh8nd9updzmxwd59gh",
			"initialAmount": 0,
			"unlockSchedule": [
			  {
		...
		"initialStakedFunds": [
		  "A-custom1g65uqn6t77p656w64023nh8nd9updzmxwd59gh"
		],
		"initialStakers": [
		  {
			"nodeID": "NodeID-7Xhw2mDxuDS44j42TCB6U5579esbSt3Lg",
			"rewardAddress": "A-custom18jma8ppw3nhx5r4ap8clazz0dps7rv5u9xde7p",
